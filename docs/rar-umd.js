...
var loadFile = function () {
  var _ref = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(opts) {
    var file, _makeBufferReader, fn, size;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            throw Error('fileSize need to be defined');
          ...
          case 8:
            ...
            _makeBufferReader = makeBufferReader(opts.file), fn = _makeBufferReader.fn, size = _makeBufferReader.size;
          ...
          case 19:
            _context.next = 21;
            return readHeaders(file, file.size + 7);
...
var validate = function () {
  var _ref2 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(file) {
    var data;
...
var readHeaders = function () {
  var _ref3 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(file, offset) {
    var data, crc, type, flags, size, entry;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return _context3.abrupt('return', file.entries);

          case 2:
            

            _context3.next = 5;
            return file.read(offset, 11);

          case 5:
            data = _context3.sent;
            crc = data.readUInt16LE(0);
            type = data.readUInt8(2);
            flags = data.readUInt16LE(3);
            size = data.readUInt16LE(5);
            ...
            _context3.t0 = type;
            _context3.next = _context3.t0 === 0x74 ? 14 : 23;
            break;

          case 14:
            _context3.next = 16;
            return parseEntry(file, offset, data);
  ...
  return function readHeaders(_x3, _x4) {
...
var parseEntry = function () {
  var _ref4 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(file, offset, headerData) {
    var flags, size, data, entry, time, nameSize;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            flags = headerData.readUInt16LE(3);
            size = headerData.readUInt16LE(5);
            _context4.next = 4;
            return file.read(offset, size);

          case 4:
            data = _context4.sent;
            entry = Object.assign({}, TEMPLATE_ENTRY);
            ...
            time = data.readUInt32LE(20).toString(2);
            ...
            entry.name = entry.path.substr(entry.path.lastIndexOf(entry.path.includes('\\') ? '\\' : '/') + 1);
  ...
  return function parseEntry(_x5, _x6, _x7) {
...
var getEntry = function () {
  var _ref5 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(file, entry) {
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 4:
            return _context5.abrupt('return', file.read(entry.offset + entry.headerSize, entry.blockSize - 1));
  ...
  return function getEntry(_x8, _x9) {
...
// RAR constants
var OS_NAMES = ['MS-DOS', 'OS/2', 'Windows', 'Unix', 'Mac', 'BeOS'];
var METHODS = {
  STORE: 0x30,
  FASTEST: 0x31,
  FAST: 0x32,
...
function makeBufferReader(buffer) {
  ...
  var fn = function fn(start, length) {
    return buffer.slice(start, start + length);
  };
  var size = buffer.length;
  return { fn: fn, size: size };
}
